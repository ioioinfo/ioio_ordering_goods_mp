...
var store = (0, _redux.createStore)(product, { custom_list: [], product_sorts: [] });
...
var AddWrapClass = function (_React$Component4) {
  _inherits(AddWrapClass, _React$Component4);

  function AddWrapClass() {
    _classCallCheck(this, AddWrapClass);

    return _possibleConstructorReturn(this, (AddWrapClass.__proto__ || Object.getPrototypeOf(AddWrapClass)).apply(this, arguments));
  }

  _createClass(AddWrapClass, [{
    key: 'componentDidMount',
    value: function componentDidMount() {
...
;
// 返回到页面
var AddWrap = (0, _reactRedux.connect)(mapStateToProps)(AddWrapClass);
