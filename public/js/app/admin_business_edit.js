...
var store = (0, _redux.createStore)(product);
              ...
              React.createElement(
                ...
                React.createElement(
                  ...
                  React.createElement(
                    'div',
                    { className: 'controls' },
                    React.createElement('input', { type: 'text', id: 'org_merchant_code' })
                  )
                ),
                React.createElement(
                  'div',
                  ...
                  React.createElement(
                    'div',
                    { className: 'controls' },
                    React.createElement('input', { type: 'text', id: 'org_merchant_name' })
                  )
                ),
                React.createElement(
                  'div',
...
;
// 返回到页面
ReactDOM.render(React.createElement(Wrap, null), document.getElementById("admin_business_edit"));
