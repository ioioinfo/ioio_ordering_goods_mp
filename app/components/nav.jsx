...
class Nav extends React.Component {
  ...
  var rows= [{name: "首页",code: "01", href:"/", icon_class: "icon-home",child: [{name: "首页",href: "index",icon_class: "icon-th"}]},
            ...
            {name: "订单",code: "05", icon_class: "icon-home"
            ,child: [{name: "在线订单列表",href: "admin_product_online_list",icon_class: "icon-th"}
                    ,{name: "历史订单列表",href: "admin_order_list",icon_class: "icon-th"}]
            },
            ...
            {name: "设置",code: "19", icon_class: "icon-home",child: [{name: "商家价格设置",href: "admin_business_set",icon_class: "icon-th"}]},
            {name: "商家订货价格",code: "20", icon_class: "icon-home",child: [{name: "商家订货价格列表",href: "admin_business_price_list",icon_class: "icon-th"}]},
          ];
